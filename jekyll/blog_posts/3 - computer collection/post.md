...
{% if computer.specsheet_version == 2 %}

{% if computer.device_quantity == 1 or computer.device_quantity == null %}
# {{ computer.device_name }}
{% endif %}

{% if computer.device_quantity > 1 %}
# {{ computer.device_name }} - Quantity {{ computer.device_quantity }}
{% endif %}
